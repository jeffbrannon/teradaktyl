...
var Paths;
(function (Paths) {
    Paths.commandLine = process.cwd();
    Paths.root = path.join(__dirname, "..", process.argv.slice(2, 3).toString());
})(Paths = exports.Paths || (exports.Paths = {}));
//# sourceMappingURL=data:application/json;base64,